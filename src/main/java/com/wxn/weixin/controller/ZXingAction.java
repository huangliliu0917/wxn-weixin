 ...
 *     画制定logo和制定描述的二维码
 * </p>
 * Created by wangkecheng on 2018/4/10.
 */
public class ZXingAction {
    ...
    public static void main(String[] args) throws WriterException {
        File logoFile = new File("C:\\Users\\wangkecheng\\Desktop\\A3.png");
        File QrCodeFile = new File("C:\\Users\\wangkecheng\\Desktop\\A4.png");
        String url = "http://www.wxn.store/page/apk/app.apk";
        String note = "访问百度连接";
